...
Lista ElimNodo(Elem e,Lista l){
	if(esvacia(l))
		return l;
	else if(e==cabeza(l))
			return resto(l);
		else return ConsL(cabeza(l),ElimNodo(e,resto(l)));
}
///IMPRIME UNA LISTA----------------------------------------------------------------------------------------
///BUSCA UN ELEMENTO EN LA LISTA-----------------------------------------------------------------------------
int BuscaElemL(Elem e,Lista l){
	if(esvacia(l))
		return 0;
	else if(e==cabeza(l))
			return 1;
		else BuscaElemL(e,resto(l));
}
...
///ELIMINA ELEMENTOS REPETIDOS DE UNA LISTA--------pendiente------------------------------------------------
...
Lista OrdLista(Lista l){
	if(esvacia(l))
	       return l;
	else return InsOrd(cabeza(l),OrdLista(resto(l)));
}  
